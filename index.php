        ...
        <section class="section hero has-bg-image" id="home" aria-label="home"
          ...
          <div class="container">
            ...
            <div class="hero-content">
              ...
              <div class="Expolre">
                <h5>I 'm</h5>
                <a href="login.html" class="btb has-before" class="row-button">
                  <span class="span">Students</span>
                </a>

                <a href="educators.html" class="btb has-before" class="row-button">
                  <span class="span">Educators</span>
                </a>

                <a href="school.html" class="btb has-before" class="row-button">
            ...
            <ul class="grid-list">
              ...
              <li>
                <div class="category-card" id="category-1" style="--color: 170, 75%, 41%">
                  ...
                  <p class="card-text">
                    Empower your school with an affordable Innovation Lab, where students can explore their creative
                    potential.
                  </p>
...
<!--
        <div id="popUpnews" class="modal">
          <div class="modal-content">
              <span class="close-button">&times;</span>
              <header>
                 <div class="header-content">
                     <h1>Breaking News: Robotics Summer Camp a Resounding Success at St. Joseph's
                      School.!</h1>
                     <p>By Amar Verma | June 14, 2024</p>
                 </div>
             </header>
         
             <main class="main">
                 <article>
                  <img src="assets/images/news-2.jpg" alt="Renewable Energy" class="responsive-image">

                  <p> Robotics Summer Camp a Resounding Success at St. Joseph's SchoolSt.</p> 
                  <p>Joseph's School Completes Exciting Robotics Summer CampSt. Joseph’s School </p>
                  <p>recently wrapped up its highly anticipated Robotics Summer Camp, which ran from June 1 to June 10. <p>
                  <p>The camp was a dynamic blend of learning, creativity, and hands-on experience, aimed at fostering</p>
                  <p> a love for technology and engineering among students.Highlights of the Camp:Innovative Learning Modules: </p>
                  <p>Students were introduced to the fundamentals of robotics, coding, and engineering principles.Hands-On Projects:</p>
                  <p>Participants worked in teams to design, build, and program their own robots.Expert Guidance:</p>
                  <p>The camp featured sessions from experienced instructors and guest lectures from industry professionals.</p>
                  <p>Competitions and Showcases: The camp culminated in a friendly competition where students demonstrated their</p>
                  <p> robots in various challenges.Student Experiences:The participants expressed immense enthusiasm and satisfaction</p>
                  <p> with the camp. Jane Doe, a seventh-grader, shared, "I loved building my own robot and seeing it come to life.<p>
                 <p> It was an unforgettable experience!"Future Plans:Building on the success of this camp, St. Joseph's School plans</p>
                 <p> to incorporate more STEM (Science, Technology, Engineering, and Mathematics) activities into its curriculum and host</p>
                 <p> similar events throughout the academic year.For more details and to view photos from the camp, visit our gallery.</p>
                 <p>Stay tuned for more exciting events and programs at St. Joseph’s School!</p>
                  </article>
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <a href="" class="card-btn" aria-label="read more" id="subscribeButton">
                      <ion-icon  name="arrow-forward-outline" aria-hidden="true"></ion-icon>
                    </a>
                    ...
                    <h3 class="h3" id="popUpNewsForm">
                      <a href="" class="card-title" >Robotics Summer Camp a Resounding Success at St. Joseph's
                        School.!</a>
                    </h3>
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" id="openLoginFormBtn" class="card-title">Robotics Summer Camp at IRIS Crown School
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">High School Student Develops Innovative 'Dog Robot' for Science
                        Fair Project.</a>
                    </h3>
        ...
        <div class="flex-contact">
          <div class="flex-item-contact-left">
            ...
            <div>
              ...
              <h6>Location:</h6>
              <p>Floor 2nd, Ram Ram Bank Chauraha, Krishna Plaza, Sector-A, Aliganjj Lucknow, Uttar Pradesh 226024</p>
          ...
          <div class="flex-item-contact-right">
            <div>
              <form action="/action_page.php">
                ...
                <input type="text" id="lname" name="lastname" placeholder="Enter your email" required>
...
--==========================================================-->
        ...
        <div class="container grid-list">
          ...
          <div class="footer-brand">
            ...
            <div class="wrapper">
              ...
              <a href="tel:+011234567890" class="footer-link">+01 000 0000 0000</a>
            </div>
  ...
  <div class="fixed-button">
    <a href="#" class="fixed-btn one" aria-label="back top top" data-back-top-btn>
      <img src="assets/images/images/telephone.png" alt="">
    <a href="#" class="fixed-btn" aria-label="back top top" data-back-top-btn>
      <img src="assets/images/images/whatsapp1.png" alt="">
    </a>
  </div>
